...
for pca_name in pca_names:
    ...
    base_dir = f'{main_path}/{pca_name}/data/4animals/gmm/'
    os.makedirs(base_dir, exist_ok=True)

    LatSpace_all = []
    
    for animal in animals:
        LatSpace_path = f'{main_path}/{pca_name}/data/{animal}/gmm/{num_patches}_PCA_gmm.npy'
    ...
    for cov_type in cov_types:
        ...
        print(f"Finished {pca_name} with {cov_type} covariance")

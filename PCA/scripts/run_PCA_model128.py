from PCA_model128 import train_incremental_pca
...
def load_and_process_file_paths(txt_file_path, new_base_path):
    ...
    Example:
        Original: /.../data/ISM_24/mye/18.png
...
# here the txt file contains the files used when training the AE, to ensure comparability
txt_file_path = '/.../AE/data/datasets_training/AE_model128_png_files_train.txt'
...
# Parameters
patch_size = 128
num_patches_per_section = 102400 # ...
...
train_incremental_pca(
    ...
    path_save=f'/..../AE/data/massivePCA/w{patch_size}pc{n_components}/PCA_model128.pkl',
